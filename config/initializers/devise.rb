...
Devise.setup do |config|
  ...
  config.omniauth :discord, Rails.application.credentials.dig(:discord, :client_id), Rails.application.credentials.dig(:discord, :client_secret), scope: "email identify"
